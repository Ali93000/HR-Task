...
namespace HR.UI.Consumer.Implementations
{
    public class CandicateConsumer : ICandicateConsumer
    {
        ...
        public async Task<GenericResponse> ApproveByManager(HRManagerApprovalRequest data)
        {
            string apiUrl = _hrConfigurations.ApiUrl;
            string serviceUrl = $"api/v1/vacancy-appliers/manager-approval";
        ...
        public async Task<GenericResponse> ApproveByDirector(HRManagerApprovalRequest data)
        {
            string apiUrl = _hrConfigurations.ApiUrl;
            string serviceUrl = $"api/v1/vacancy-appliers/director-approval";
